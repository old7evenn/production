...
createObserver('.animationLeftFragment1', 'animation', 'left')
createObserver('.animationLeftFragment2', 'animation', 'left')
createObserver('.animationLeftFragment3', 'animation', 'left')
